...
# 以下説明
tellraw @s {"type":"text", "text":"===FPS1にようこそ！===","color":"aqua", "bold":true}
...
tellraw @s {"type":"text", "text":"下線付きメッセージをクリックでコマンドなどがトリガーされます","clickEvent":{"action":"open_url","value":"https://dir.hakuteialpha.com/mc/fps1/sample_map/"},"color":"aqua","underlined":true}
